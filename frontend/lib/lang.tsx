...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    "help.howto.step2": "Click 'Send Code' button on the game card.",
    "help.howto.step3": "Open Steam on your device and log in with the provided account credentials.",
  ...
  ru: {
    ...
    "help.howto.step2": "Нажмите кнопку 'Отправить код' на карточке игры.",
    "help.howto.step3": "Откройте Steam на своём устройстве и войдите с указанными учётными данными.",
  ...
  ar: {
    ...
    "help.howto.step2": "انقر على زر 'إرسال الرمز' في بطاقة اللعبة.",
    "help.howto.step3": "افتح Steam على جهازك وسجّل الدخول باستخدام بيانات الحساب المقدمة.",
